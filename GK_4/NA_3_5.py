...
buttons_state = [0,0,0,0,0,0,0,0,0]
light_values = [0.1, 0.1, 0.0, 0.8, 0.8, 0.0, 1.0, 1.0, 1.0]
up_button_state = 0
down_button_state = 0
...
def updateValues():
    ...
    if up_button_state:
        for i in range(9):
            if buttons_state[i] == 1:
                if light_values[i] < 1.0:
                    light_values[i] += 0.1
                    light_values[i] = round(light_values[i], 1)
                    print ('light_ambient', light_values[0], light_values[1], light_values[2])
                    print ('light_diffuse', light_values[3], light_values[4], light_values[5])
                    print ('light_specular', light_values[6], light_values[7], light_values[8])
                    print()
                break
    ...
    light_ambient = [light_values[0], light_values[1], light_values[2], 1.0]
    light_diffuse = [light_values[3], light_values[4], light_values[5], 1.0]
    light_specular = [light_values[6], light_values[7], light_values[8], 1.0]
