...
matrixWithTextures = numpy.zeros((N, N, 2))
    ...
    for i in range(0, N):
        ...
        for j in range(0, N):
            ...
            if (i > (N / 2)):
                ...
                matrixWithTextures[i][j][0] =  (v/2)
                matrixWithTextures[i][j][1] =  -(u * 2)
                
            else:
                matrixWithTextures[i][j][0] = 0.5 + (v/2)
                matrixWithTextures[i][j][1] =  (u * 2)
